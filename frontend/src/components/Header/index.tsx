  ...
  <form onSubmit={handleSearch} className="relative">
    <div className="relative">
      ...
      <input
        ...
        className="bg-transparent pl-9 pr-4 text-black focus:outline-none dark:text-white xl:w-125  border-2 border-opacity-45 border-orange-500 rounded-full py-2 px-3"
        value={searchTerm}
