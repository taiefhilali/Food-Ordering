...
// Play the notification sound if there are new notifications
if (audioRef.current) {
  console.log('Playing notification sound after fetching notifications');
              ...
              <li key={index} className="relative">
                ...
                >
                  <div className="flex flex-col gap-2">
                    <div className="text-slate-500 dark:text-white font-normal text-base">
  ...
  {/* {loading ? (
    ...
    notifications.map((notification, index) => (
      <Link
        key={index}
        to="#"
        className="block px-4 py-2.5 text-sm font-medium text-black transition hover:bg-gray-100 dark:text-white dark:hover:bg-strokedark"
      >
...
//       // Play the notification sound when a new notification is received via socket
//       if (audioRef.current) {
//         console.log('Playing notification sound after receiving socket message');
//         audioRef.current.play().catch((error) => {
//           console.error('Error playing notification sound:', error);
//         });
//       }
...
//         onFocus={() => setDropdownOpen(true)}
//         onBlur={() => setDropdownOpen(false)}
//         className={`absolute right-0 mt-2.5 w-72 divide-y divide-stroke overflow-hidden rounded border border-stroke bg-white shadow-default dark:divide-strokedark dark:border-strokedark dark:bg-boxdark ${dropdownOpen === true ? 'block' : 'hidden'}`}
//       >
...
//               <div className="flex items-center justify-between">
//                 <div className="flex items-center">
//                   <img src={notification.data.imageUrl} alt="user" className="mr-3 h-8 w-8 rounded-full object-cover" />
//                   <p>{notification.data.name}</p>
//                 </div>
